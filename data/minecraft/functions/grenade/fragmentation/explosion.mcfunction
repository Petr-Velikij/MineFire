...
setblock 0 -63 0 air
setblock 0 -63 0 oak_sign{Text1:'[{"selector":"@p[tag=Owner]"},{"text":" используя "},{"text":"[","color":"dark_red"},{"translate":"gren[1].name","color":"dark_red"},{"text":"] ","color":"dark_red"}]'} replace
tag @a remove Owner

scoreboard players set OptDist varTime 40
scoreboard players set MaxDist varTime 80
scoreboard players set Damage varTime 270
