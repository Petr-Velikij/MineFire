...
execute if score @s modeFire matches 1 run title @s subtitle [{"text":"Импульсный ","color":"red"}]
execute if score @s modeFire matches 2 run title @s subtitle [{"text":"Накопительный ","color":"red"}]
