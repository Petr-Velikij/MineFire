...
execute if score @s Supply matches ..-1 run scoreboard players add @s Supply 1
execute if score @s Supply matches -1 run scoreboard players set @s Supply 1
...
execute if score @s Supply matches 5.. if score @s modeFire matches 1 run function gun/amper/progresbar1
execute if score @s Supply matches 5.. if score @s modeFire matches 2 run function gun/amper/progresbar2
