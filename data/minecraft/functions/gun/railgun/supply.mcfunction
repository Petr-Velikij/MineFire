...
execute if score @s Supply matches 35 run function minecraft:gun/railgun/gilza

execute if score @s Supply matches 20 run playsound custom.gun.railgun.supply_1d player @a[distance=..7] ~ ~ ~ 1 1
execute if score @s Supply matches 15 run function minecraft:gun/railgun/gilza
