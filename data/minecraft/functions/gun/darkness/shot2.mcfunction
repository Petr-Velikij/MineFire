data merge entity @s {damage:0.89d,crit:0b,PierceLevel:0b,Tags:["darkness","particle_crit"],CustomPotionEffects:[{Id:15,Amplifier:0b,Duration:50},{Id:20,Amplifier:1b,Duration:80}]}
