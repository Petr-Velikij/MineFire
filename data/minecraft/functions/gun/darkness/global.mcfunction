...
execute if score @s PKM_2 matches 1.. run function minecraft:gun/darkness/shot
...
execute unless score @s reload matches 0 run function minecraft:gun/darkness/reload_time