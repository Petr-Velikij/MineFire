execute if score @s Time_PKM_2 matches 4 unless score @s ID.module matches 1 run playsound minecraft:custom.gun.magma.end_2d player @s ~ ~ ~ 1 1
execute if score @s Time_PKM_2 matches 4 unless score @s ID.module matches 1 run playsound minecraft:custom.gun.magma.end_1d player @a[distance=0.1..10] ~ ~1.6 ~ 1 1
execute if score @s Time_PKM_2 matches 3 if score @s ID.module matches 1 run playsound minecraft:custom.gun.magma.end_2d player @s ~ ~ ~ 1 1.1
execute if score @s Time_PKM_2 matches 3 if score @s ID.module matches 1 run playsound minecraft:custom.gun.magma.end_1d player @a[distance=0.1..10] ~ ~1.6 ~ 1 1.1
