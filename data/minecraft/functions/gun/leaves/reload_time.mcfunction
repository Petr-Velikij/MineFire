...
execute if score @s reload matches 57 run playsound custom.gun.leaves.supply_2d_1 player @s ~ ~ ~ 1 1.25
execute if score @s reload matches 51 run playsound custom.gun.sniper.oboima_2d_3 player @s ~ ~ ~ 1 1.25
...
execute if score @s reload matches 3 run playsound custom.gun.leaves.supply_2d_2 player @s ~ ~ ~ 1 1.25
