...
execute if score @s reload matches 58 run playsound custom.gun.leaves.supply_2d_1 player @s ~ ~ ~ 1 1
...
execute if score @s reload matches 4 run playsound custom.gun.leaves.supply_2d_2 player @s ~ ~ ~ 1 1
