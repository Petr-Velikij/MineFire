...
execute unless score @s sneak_time matches 0 if score @s stamina matches -50.. unless score idModule varTime matches 6 run scoreboard players remove @s stamina 5
