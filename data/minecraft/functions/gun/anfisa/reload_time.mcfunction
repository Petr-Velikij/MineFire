...
execute if score @s reload matches 60 run playsound custom.gun.assault_rifle.oboima_2d_1 player @s ~ ~ ~ 1 1
...
execute if score @s reload matches 1 run function minecraft:gun/anfisa/reload