...
execute if score @s modeFire matches 1 run title @s subtitle [{"text":"Одиночный","color":"red"}]
execute if score @s modeFire matches 1 run playsound custom.gun.anfisa.mod_1 voice @s ~ ~ ~ 1 1.15
execute if score @s modeFire matches 2 run title @s subtitle [{"text":"Помощь","color":"red"}]
execute if score @s modeFire matches 2 run playsound custom.gun.anfisa.mod_2 voice @s ~ ~ ~ 1 1.15
execute if score @s modeFire matches 3 run title @s subtitle [{"text":"Анфиса","color":"blue"}]
execute if score @s modeFire matches 3 run playsound custom.gun.anfisa.mod_3 voice @s ~ ~ ~ 1 1.15
