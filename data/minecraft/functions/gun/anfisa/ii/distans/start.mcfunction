...
execute at @s positioned ~ ~1.2 ~ positioned ^ ^ ^1.5 run function minecraft:gun/anfisa/ii/distans/loop
tag @s remove Owner
...
execute if score @s[tag=Target] Anfisa matches 0 if score @s Time_PKM_2 matches 100 run function gun/anfisa/ii/go_shot
tag @s remove Target