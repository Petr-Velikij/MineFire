execute if score @s modeFire matches 3 run function gun/anfisa/auto/ii

execute if score @s Supply matches 1.. run scoreboard players remove @s Supply 1
#execute if score @s Supply matches 1 run function minecraft:gun/anfisa/shot3
...
execute if score @s[tag=!camouflage_gun] ID.armor matches 1 run function minecraft:gun/anfisa/camouflage_gun

execute unless score @s reload matches 0 run function minecraft:gun/anfisa/reload_time