...
execute if score @s Supply matches 2 if score @s modeFire matches 3 run function minecraft:gun/chastiser/shot3
execute if score @s Supply matches 3 if score @s modeFire matches 3 run function minecraft:gun/chastiser/shot3
