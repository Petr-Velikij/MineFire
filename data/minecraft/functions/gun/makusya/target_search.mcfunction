...
execute if score @s Loop matches 0 run function gun/makusya/set_point
execute positioned ^ ^ ^0.5 unless block ~ ~ ~ #no_collider run function gun/makusya/set_point
