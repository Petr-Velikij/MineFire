...
execute if score @s ArrowLive matches 2.. run particle minecraft:smoke ~ ~ ~ 0 0 0 0.02 3 force @a[distance=..175]
execute if score @s ArrowLive matches 2.. if entity @s[tag=up] run particle minecraft:smoke ~ ~ ~ 0.05 0.05 0.05 0.1 3 force @a[distance=..175]
