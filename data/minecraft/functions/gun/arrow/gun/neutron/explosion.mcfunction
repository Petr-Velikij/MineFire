...
effect give @a[gamemode=!spectator,distance=..5] nausea 6 0 false
effect give @a[gamemode=!spectator,distance=..5] poison 5 0 false
effect give @a[gamemode=!spectator,distance=..5] hunger 6 0 false
