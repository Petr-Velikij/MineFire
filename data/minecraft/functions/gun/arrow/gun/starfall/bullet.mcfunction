...
execute if score @s ArrowLive matches 20.. if entity @e[type=#target,distance=..2] positioned ~ ~1 ~ run function gun/arrow/gun/starfall/explosion
execute if score @s ArrowLive matches 80 run function gun/arrow/gun/starfall/explosion