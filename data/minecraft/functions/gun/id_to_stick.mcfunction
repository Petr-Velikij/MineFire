...
execute in minecraft:overworld run data modify block 0 -64 0 Items[0].id set from entity @s Inventory[{Slot:-106b}].id
execute in minecraft:overworld run data modify block 0 -64 0 Items[0].tag set from entity @s Inventory[{Slot:-106b}].tag
...
scoreboard players set *Max varTime 25
...
execute in minecraft:overworld run data modify block 0 -64 0 Items[{Slot:0b}].id set value carrot_on_a_stick
...
execute in minecraft:overworld run loot replace entity @s weapon.offhand 1 mine 0 -64 0 air{drop_contents:1b}