...
execute if score idModule varTime matches 6 run scoreboard players operation coefficient Random *= *8 CONST
execute if score idModule varTime matches 6 run scoreboard players operation coefficient Random /= *10 CONST
