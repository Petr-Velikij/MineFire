...
execute if score @s reload matches 83 run playsound custom.gun.sniper.oboima_2d_3 player @s ~ ~ ~ 1 0.7
execute if score @s reload matches 52 run playsound custom.gun.sniper.oboima_2d_1 player @s ~ ~ ~ 1 0.7
execute if score @s reload matches 26 run playsound custom.gun.sniper.oboima_2d_2 player @s ~ ~ ~ 1 0.7
