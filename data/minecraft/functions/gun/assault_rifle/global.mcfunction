execute if score @s PKM_2 matches 1.. run function minecraft:gun/assault_rifle/shot
...
execute unless score @s reload matches 0 run function minecraft:gun/assault_rifle/reload_time