execute if score @s PKM_2 matches 1.. run function pistol/silent/shot
...
execute unless score @s reload_pistol matches 0 run function pistol/silent/reload_time