...
scoreboard players remove *InHolder varTime 100
...
scoreboard players operation *InHolder varTime /= *100 CONST
...
scoreboard players remove *InHolder varTime 1
...
execute unless score *InHolder varTime matches 0 if score @s Supply_pistol matches 0 in minecraft:overworld run data modify block 0 -64 0 Items[{Slot:0b}].tag merge value {ChargedProjectiles:[{id:"minecraft:arrow",Count:1b},{},{}],Charged:1b}
...
execute unless score @s Supply_pistol matches 0 in minecraft:overworld run data modify block 0 -64 0 Items[{Slot:0b}].tag merge value {ChargedProjectiles:[{},{},{}],Charged:0b}
