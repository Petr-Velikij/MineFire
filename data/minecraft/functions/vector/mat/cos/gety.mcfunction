...
scoreboard players operation *ANG varTime = *YR 
execute if score *YR varTime matches 180000.. run scoreboard players remove *ANG varTime 180000
execute if score *ANG varTime matches ..90000 run function minecraft:vector/mat/cos/cos
...
execute if score *zcbm_90 varTime matches 1 run function minecraft:vector/mat/sin/sin



scoreboard players operation *COSY varTime = *M1 
