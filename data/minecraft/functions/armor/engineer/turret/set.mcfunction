...
summon wolf ~ ~ ~ {Silent:1b,Sitting:1b,Tags:["turret","turret_collider","turret_new"],CustomName:'{"text":"Дрон"}',ActiveEffects:[{Id:14,Amplifier:0b,Duration:99999999,ShowParticles:0b}],Attributes:[{Name:generic.follow_range,Base:40},{Name:generic.movement_speed,Base:0.4}]}
