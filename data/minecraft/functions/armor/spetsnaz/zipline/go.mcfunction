...
execute at @e[type=armor_stand,tag=zipline,distance=..1,sort=nearest] run summon arrow ~ ~0.4 ~ {NoGravity:1b,damage:0d,Tags:["zipline","new_zipline"],SoundEvent:"entity.armor_stand.hit"}
