execute as @e[type=arrow,tag=selected,distance=..15,limit=1] run function armor/guardian/shild/math/damage
scoreboard players operation @s Power -= Damage varTime
