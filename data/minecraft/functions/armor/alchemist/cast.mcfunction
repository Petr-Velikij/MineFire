...
execute positioned ~ ~1 ~ as @e[type=arrow,tag=,sort=nearest,limit=1] run function minecraft:armor/alchemist/fire/shot

playsound minecraft:entity.illusioner.cast_spell player @a[distance=..20] ~ ~ ~ 2 1
scoreboard players set @s armor_cooldown 300