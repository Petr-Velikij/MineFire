...
execute if score *1 varTime matches ..2 if score @s armor_cooldown2 matches 2 run give @s ender_pearl
execute if score *1 varTime matches ..2 if score @s armor_cooldown2 matches 0 run scoreboard players set @s armor_cooldown2 600
execute if score *1 varTime matches 4.. run clear @s ender_pearl
execute if score *1 varTime matches 4.. run give @s ender_pearl 3
