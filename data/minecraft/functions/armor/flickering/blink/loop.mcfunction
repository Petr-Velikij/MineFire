...
execute if score End varTime matches 0 positioned ^ ^ ^0.5 unless block ~ ~ ~ #no_collider align xyz positioned ~0.5 ~1 ~0.5 if block ~ ~ ~ #no_collider run function armor/flickering/blink/marcer
