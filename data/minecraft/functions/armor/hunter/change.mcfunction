execute if block ~ ~-1 ~ oak_leaves run scoreboard players set @s color_camouflage 6129983
execute if block ~ ~-1 ~ oak_leaves run scoreboard players set *1 varTime 800
execute if block ~ ~-1 ~ spruce_leaves run scoreboard players set @s color_camouflage 5406546
execute if block ~ ~-1 ~ spruce_leaves run scoreboard players set *1 varTime 800
execute if block ~ ~-1 ~ grass_block run scoreboard players set @s color_camouflage 11527563
execute if block ~ ~-1 ~ grass_block run scoreboard players set *1 varTime 801
...
execute in minecraft:overworld store result block 0 -64 0 Items[0].tag.CustomModelData int 1 run scoreboard players get *1 varTime
